...
function E(e3) {
  const {
    ...
    width: a2,
    height: h2
  }, l2] = reactExports.useState(V), u2 = (function() {
    const e4 = reactExports.useRef(false);
    return reactExports.useEffect(() => (e4.current = true, () => {
      e4.current = false;
    }), []), reactExports.useCallback(() => e4.current, []);
  })(), c2 = reactExports.useRef(_extends({}, V)), m2 = reactExports.useRef(void 0);
  return m2.current = e3.onResize, reactExports.useEffect(() => {
...
const H = j, Y = F, k = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement ? reactExports.useLayoutEffect : reactExports.useEffect;
class $ {
  constructor() {
    this._size = void 0;
  }
...
const xe = reactExports.forwardRef(({
  ...
  const V2 = reactExports.useRef(null), N2 = reactExports.useRef([]), D2 = reactExports.useRef(/* @__PURE__ */ new Map()), M2 = reactExports.useRef(null), A2 = reactExports.useRef(/* @__PURE__ */ new Map()), j2 = reactExports.useRef(new $()), F2 = reactExports.useRef([]), [Y2, B2] = reactExports.useState(false);
  const R2 = reactExports.useMemo(() => React.Children.toArray(r2).filter(React.isValidElement), [r2]), W2 = reactExports.useCallback((e3) => {
  ...
  return reactExports.useImperativeHandle(_2, () => ({
    reset: () => {
      if (g2) g2();
      else {
        var _M$current2;
  ...
  }, [R2, Y2, u2, c2, v2]), reactExports.useEffect(() => {
    M2.current && (M2.current.onDidChange = w2);
  }, [w2]), reactExports.useEffect(() => {
  ...
  }, React.Children.toArray(r2).map((t2) => {
    if (!React.isValidElement(t2)) return null;
    const i2 = t2.key;
    return "Allotment.Pane" === t2.type.displayName ? (D2.current.set(i2, t2.props), React.cloneElement(t2, {
      key: i2,
      ref: (e3) => {
        const s2 = t2.ref;
...
const LeftPanel = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "left-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tab-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Preview" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, padding: "20px", display: "flex", alignItems: "center", justifyContent: "center", color: "#666" }, children: "Preview Area (Empty)" })
  ] });
};
const RightPanel = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "right-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tab-bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Chat" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, padding: "20px", display: "flex", alignItems: "center", justifyContent: "center", color: "#666" }, children: "Chat Area (Empty)" })
  ] });
};
const SplitPanel = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "split-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Ve, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ve.Pane, { minSize: 200, preferredSize: 400, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LeftPanel, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ve.Pane, { minSize: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RightPanel, {}) })
  ] }) });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SplitPanel, {}) });
}
